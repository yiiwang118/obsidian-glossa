...
### Added
- **`tests/` stress-test suite** — 7-layer (A unit / B integration / C provider fuzz / D perf / E security / F e2e via happy-dom / G chromium via Puppeteer). 1181 assertions, ~10 s wall-clock.
